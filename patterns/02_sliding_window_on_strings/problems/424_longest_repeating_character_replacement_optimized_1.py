...
#
# The time complexity for this is O(26 )N. Here max(counterMap.values()) is of complexity O(26N).
...
class Solution:
    def characterReplacement(self, s: str, k: int) -> int:
        ...
        while windowEnd < len(s):
            ...
            # Keep move left if that is the case.
            while (windowEnd - windowStart + 1 - max(counterMap.values()) > k) and windowStart < windowEnd:
